<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <jsp:include page="header.jsp" />
				...
				<h2>Informations - delivery</h2>
			<img src="images/ups.jpg" style="width:130px;position:absolute;margin-left:680px;" alt=""/>
<br/>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tbody><tr>
			<td width="33%"><strong>Delivery  options</strong></td>
			<td width="33%"><strong>Cost</strong></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td rowspan="1" valign="top">Free</td>
		</tr>
	</tbody></table><br/>&nbsp;<br/>
